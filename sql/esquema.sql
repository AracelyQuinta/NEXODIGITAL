...
-- ==============================================================================
-- TABLA DE USUARIOS (Semana 14: sistema de autenticación / login)
-- ==============================================================================
-- Almacena los usuarios autorizados para ingresar al sistema.
-- La contraseña NUNCA se guarda en texto plano: se almacena su "hash" (una
-- versión cifrada irreversible) generado con generate_password_hash() de Werkzeug.
-- El campo 'usuario' es UNIQUE para impedir nombres de usuario duplicados.
